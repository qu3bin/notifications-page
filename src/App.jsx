  ...
  return (
    <main className="App">
      ...
      <article className="notification unread">
        ...
        <div>
          <p className="detail dot"><span className="user">Mark Webber</span> reacted to your recent post <a className="link">My first tournament today!</a></p>
      ...
      <article className="notification unread">
        ...
        <div>
          <p className="detail dot"><span className="user">Angela Gray</span> followed you</p>
      ...
      <article className="notification unread">
        ...
        <div>
          <p className="detail dot"><span className="user">Jacob Thompson</span> has joined your group <a className="link">Chess Club</a></p>
      ...
      <article className="notification">
        ...
        <div>
          <p className="detail"><span className="user">Rizky Hasanuddin</span> sent you a private message</p>
      ...
      <article className="notification justify">
        ...
        <div>
          <p className="detail"><span className="user">Kimberly Smith</span> commented on your picture</p>
      ...
      <article className="notification">
        ...
        <div>
          <p className="detail"><span className="user">Nathan Peterson</span> reacted to your recent post <a className="link">5 end-game strategies to increase your win rate</a></p>
      ...
      <article className="notification">
        ...
        <div>
          <p className="detail"><span className="user">Anna Kim</span> left the group <a className="link">Chess Club</a></p>
          <p className="ago">2 weeks ago</p>
        </div>
      </article>
    </main>
